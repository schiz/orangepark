$( document ).ready(function() {
	//small-menu-cat
	$(".small-menu-cat section").on("click", function (e) {
		e.preventDefault();
		$(this).addClass("active").siblings('.active').removeClass("active");
	});

	$(".small-menu-cat section ul").on('click', function (e) {
		e.stopPropagation();
	})
	...
	$("a.switcher").on("click", function (e) {
		e.preventDefault();
		var	$container = $(this).parents(".look-option");

		if (!$container.hasClass("paged")) {
	...
	//page look active class
		var $nav = $('.navigation'),
			$pagination = $('.navigation span'),
			$navPagination = $nav.find('.prev, .next'),
			index = 0,
			$allPagination = $pagination.length;
	...
	//switch pages
		$navPagination.on('click', function (e) {
			e.preventDefault();
			var currentActiveIndex = $('span.active').index();

			// console.log(currentActiveIndex + 1);

			$('span.active', $nav).removeClass('active');
			$('span', $nav).eq(currentActiveIndex + 1).addClass('active');
			if (currentActiveIndex + 1 == $allPagination ) {
  ...
  clicks(".click-b1300",b1300,".b1300");
  // 216
